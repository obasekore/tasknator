...
loadjs.ready(["fUsersadd", "datetimepicker"], function () {
    ...
    ew.createDateTimePicker("fUsersadd", "x_CreatedAt", ew.deepAssign({"useCurrent":false,"display":{"sideBySide":false}}, options));
});
</script>
<?php } ?>
</span>
...
loadjs.ready(["fUsersadd", "datetimepicker"], function () {
    ...
    ew.createDateTimePicker("fUsersadd", "x_UpdatedAt", ew.deepAssign({"useCurrent":false,"display":{"sideBySide":false}}, options));
});
</script>
<?php } ?>
</span>
