...
// Project
define(PROJECT_NAMESPACE . "PROJECT_NAME", "taskinator_project_file"); // Project name
define(PROJECT_NAMESPACE . "PROJECT_ID", "{FD897DF6-0387-4406-A2D6-F45FB6E3185A}"); // Project ID
