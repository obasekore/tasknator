...
$CONFIG = [
    ...
    "PROJECT_STYLESHEET_FILENAME" => "css/taskinator_project_file.css", // Project stylesheet file name
    ...
    "AES_ENCRYPTION_KEY" => "AOqqpnzzMt2VH2vkvVtx0Au8BLijFzZFZq0MnvAxRtQ=", // AES encryption key (base64 encoded)
    ...
    "AUTH_CONFIG" => [
        "providers" => [
            ...
            "Azure" => [
                "enabled" => false,
                "adapter" => 'PHPMaker2024\\taskinator_project_file\\AzureAD',
                "keys" => [
                    "id" => '',
            ...
            "Saml" => [
                "enabled" => false,
                "adapter" => 'PHPMaker2024\\taskinator_project_file\\Saml2',
    ...
    // Export Log
    "EXPORT_PATH" => "export-fd897df6-0387-4406-a2d6-f45fb6e3185a", // Export folder
    ...
    // Email
    "SENDER_EMAIL" => "_mainaccount@vln.src.mybluehost.me", // Sender email address
