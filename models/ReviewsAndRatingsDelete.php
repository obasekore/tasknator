 ...
 * Page class
 */
class ReviewsAndRatingsDelete extends ReviewsAndRatings
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "ReviewsAndRatingsDelete";
    ...
    // CSS class/style
    public $CurrentPageName = "ReviewsAndRatingsDelete";
    ...
    public function run()
    {
        ...
        if ($filter == "") {
            $this->terminate("ReviewsAndRatingsList"); // Prevent SQL injection, return to list
            return;
        }
        ...
        if ($this->isShow()) { // Load records for display
            ...
            if ($this->TotalRecords <= 0) { // No record found, exit
                $this->Recordset?->free();
                $this->terminate("ReviewsAndRatingsList"); // Return to list
                return;
            }
        }
