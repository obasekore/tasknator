 ...
 * Page class
 */
class ServiceDelete extends Service
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "ServiceDelete";
    ...
    // CSS class/style
    public $CurrentPageName = "ServiceDelete";
    ...
    public function run()
    {
        ...
        if ($filter == "") {
            $this->terminate("ServiceList"); // Prevent SQL injection, return to list
            return;
        }
        ...
        if ($this->isShow()) { // Load records for display
            ...
            if ($this->TotalRecords <= 0) { // No record found, exit
                $this->Recordset?->free();
                $this->terminate("ServiceList"); // Return to list
                return;
            }
        }
