...
class PersonalData
{
    ...
    public function run()
    {
        ...
        $Breadcrumb = Breadcrumb::create("splash")->add("personal_data", "PersonalDataTitle", CurrentUrl(), "ew-personal-data", "", true);
    ...
    {
        $fldNames = ["FirstName", "LastName", "Email", "Password", "Avatar"];
