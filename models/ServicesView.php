...
class ServicesView extends Services
{
    ...
    // Page object name
    public $PageObjName = "ServicesView";
    ...
    // CSS class/style
    public $CurrentPageName = "ServicesView";
    ...
    public function __construct()
    {
        ...
        if (($keyValue = Get("ServiceID") ?? Route("ServiceID")) !== null) {
            $this->RecKey["ServiceID"] = $keyValue;
        }
    ...
    public function run()
    {
        ...
        if (($keyValue = Get("ServiceID") ?? Route("ServiceID")) !== null) {
            ...
            $returnUrl = "ServicesList"; // Return to list
        }
        ...
        switch ($this->CurrentAction) {
            case "show": // Get a record to display
                    ...
                    if (!$res) { // Load record based on key
                        ...
                        $returnUrl = "ServicesList"; // No matching record, return to list
                    }
                break;
        }
        if ($returnUrl != "") {
