...
class TasksAdd extends Tasks
{
    ...
    // CSS class/style
    public $CurrentPageName = "TasksAdd";
        ...
        switch ($this->CurrentAction) {
            ...
            case "insert": // Add new record
                ...
                if ($this->addRow($rsold)) { // Add successful
                    ...
                    } elseif (GetPageName($returnUrl) == "TasksView") {
    ...
    protected function getAddRow()
    {
        ...
        // TaskerID
        $this->TaskerID->setDbValueDef($rsnew, $this->TaskerID->CurrentValue, false);

        // Location
        $this->Location->setDbValueDef($rsnew, $this->Location->CurrentValue, false);

        // StartTime
        $this->StartTime->setDbValueDef($rsnew, UnFormatDateTime($this->StartTime->CurrentValue, $this->StartTime->formatPattern()), false);
