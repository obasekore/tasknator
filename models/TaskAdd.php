...
class TaskAdd extends Task
{
    ...
    // CSS class/style
    public $CurrentPageName = "TaskAdd";
        ...
        switch ($this->CurrentAction) {
            case "copy": // Copy an existing record
                if (!$rsold) { // Record not loaded
                    ...
                    $this->terminate("TaskList"); // No matching record, return to list
                    return;
                }
                break;
            case "insert": // Add new record
                ...
                if ($this->addRow($rsold)) { // Add successful
                    ...
                    if (GetPageName($returnUrl) == "TaskList") {
                        $returnUrl = $this->addMasterUrl($returnUrl); // List page, return to List page with correct master key if necessary
                    } elseif (GetPageName($returnUrl) == "TaskView") {
                    ...
                    if ($this->IsModal && $this->UseAjaxActions) {
                        ...
                        if (GetPageName($returnUrl) != "TaskList") {
                            ...
                            $returnUrl = "TaskList"; // Return list page content
                        }
                    }
    ...
    protected function loadFormValues()
    {
        ...
        // Check field name 'tasker_id' first before field var 'x_tasker_id'
        $val = $CurrentForm->hasValue("tasker_id") ? $CurrentForm->getValue("tasker_id") : $CurrentForm->getValue("x_tasker_id");
        if (!$this->tasker_id->IsDetailKey) {
            if (IsApi() && $val === null) {
                $this->tasker_id->Visible = false; // Disable update for API request
            } else {
                $this->tasker_id->setFormValue($val, true, $validate);
            }
        }
    ...
    public function restoreFormValues()
    {
        ...
        $this->tasker_id->CurrentValue = $this->tasker_id->FormValue;
    ...
    public function renderRow()
    {
        ...
        // tasker_id
        $this->tasker_id->RowCssClass = "row";
    ...
    protected function validateForm()
    {
        ...
        $validateForm = true;
            ...
            if ($this->tasker_id->Visible && $this->tasker_id->Required) {
                if (!$this->tasker_id->IsDetailKey && EmptyValue($this->tasker_id->FormValue)) {
                    $this->tasker_id->addErrorMessage(str_replace("%s", $this->tasker_id->caption(), $this->tasker_id->RequiredErrorMessage));
                }
            }
            if (!CheckInteger($this->tasker_id->FormValue)) {
                $this->tasker_id->addErrorMessage($this->tasker_id->getErrorMessage(false));
            }
    ...
    protected function getAddRow()
    {
        ...
        // tasker_id
        $this->tasker_id->setDbValueDef($rsnew, $this->tasker_id->CurrentValue, false);
    ...
    protected function restoreAddFormFromRow($row)
    {
        ...
        if (isset($row['tasker_id'])) { // tasker_id
            $this->tasker_id->setFormValue($row['tasker_id']);
        }
