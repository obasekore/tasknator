...
class UserAdd extends User
{
    ...
    // CSS class/style
    public $CurrentPageName = "UserAdd";
                ...
                if ($this->addRow($rsold)) { // Add successful
                    ...
                    if ($this->IsModal && $this->UseAjaxActions) {
                        ...
                        if (GetPageName($returnUrl) != "UserList") {
                            ...
                            $returnUrl = "UserList"; // Return list page content
                        }
                    }
    ...
    {
        $this->role_id->DefaultValue = $this->role_id->getDefault(); // PHP
        $this->role_id->OldValue = $this->role_id->DefaultValue;
    }
    ...
    public function renderRow()
    {
        ...
        if ($this->RowType == RowType::VIEW) {
            ...
            if (!$Security->isAdmin() && $Security->isLoggedIn() && !$this->userIDAllow("add")) { // Non system admin
                $this->_email->CurrentValue = CurrentUserID();
            ...
            if (!$Security->canAdmin()) { // System admin
                ...
                if ($this->role_id->ViewValue !== null) { // Load from cache
                    ...
                    if ($curVal == "") {
                        ...
                        $filterWrk = SearchFilter($this->role_id->Lookup->getTable()->Fields["UserLevelID"]->searchExpression(), "=", $this->role_id->CurrentValue, $this->role_id->Lookup->getTable()->Fields["UserLevelID"]->searchDataType(), "");
                    }
    ...
    protected function getAddRow()
    {
        ...
        // role_id
        if ($Security->canAdmin()) { // System admin
            $this->role_id->setDbValueDef($rsnew, $this->role_id->CurrentValue, strval($this->role_id->CurrentValue) == "");
        }
    ...
    protected function restoreAddFormFromRow($row)
    {
        ...
        if (isset($row['token'])) { // token
            $this->_token->setFormValue($row['token']);
        }
