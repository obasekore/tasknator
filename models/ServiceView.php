...
class ServiceView extends Service
{
    ...
    // Page object name
    public $PageObjName = "ServiceView";
    ...
    // CSS class/style
    public $CurrentPageName = "ServiceView";
    ...
    public function run()
    {
        ...
        if (($keyValue = Get("id") ?? Route("id")) !== null) {
            ...
            $returnUrl = "ServiceList"; // Return to list
        }
        ...
        switch ($this->CurrentAction) {
            case "show": // Get a record to display
                    ...
                    if (!$res) { // Load record based on key
                        ...
                        $returnUrl = "ServiceList"; // No matching record, return to list
                    }
                break;
        }
        if ($returnUrl != "") {
