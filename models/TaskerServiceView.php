 ...
 * Page class
 */
class TaskerServiceView extends TaskerService
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "TaskerServiceView";
    ...
    // CSS class/style
    public $CurrentPageName = "TaskerServiceView";
    ...
    public function __construct()
    {
        ...
        if (($keyValue = Get("TaskerServiceID") ?? Route("TaskerServiceID")) !== null) {
            $this->RecKey["TaskerServiceID"] = $keyValue;
        }
    ...
    public function run()
    {
        ...
        if (($keyValue = Get("TaskerServiceID") ?? Route("TaskerServiceID")) !== null) {
            ...
            $this->RecKey["TaskerServiceID"] = $this->TaskerServiceID->QueryStringValue;
        } elseif (Post("TaskerServiceID") !== null) {
            $this->TaskerServiceID->setFormValue(Post("TaskerServiceID"));
            $this->RecKey["TaskerServiceID"] = $this->TaskerServiceID->FormValue;
        } elseif (IsApi() && ($keyValue = Key(0) ?? Route(2)) !== null) {
            $this->TaskerServiceID->setQueryStringValue($keyValue);
            $this->RecKey["TaskerServiceID"] = $this->TaskerServiceID->QueryStringValue;
        } elseif (!$loadCurrentRecord) {
            $returnUrl = "TaskerServiceList"; // Return to list
        }
        ...
        switch ($this->CurrentAction) {
            case "show": // Get a record to display
                    ...
                    if (!$res) { // Load record based on key
                        ...
                        $returnUrl = "TaskerServiceList"; // No matching record, return to list
                    }
                break;
        }
        if ($returnUrl != "") {
