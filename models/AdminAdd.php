...
class AdminAdd extends Admin
{
    ...
    protected function getAddRow()
    {
        ...
        // last_login
        $this->last_login->setDbValueDef($rsnew, UnFormatDateTime($this->last_login->CurrentValue, $this->last_login->formatPattern()), false);
        return $rsnew;
    }
    ...
    protected function restoreAddFormFromRow($row)
    {
        ...
        if (isset($row['last_login'])) { // last_login
            $this->last_login->setFormValue($row['last_login']);
        }
    }
