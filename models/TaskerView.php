 ...
 * Page class
 */
class TaskerView extends Tasker
{
    use MessagesTrait;
    ...
    // CSS class/style
    public $CurrentPageName = "TaskerView";
    ...
    public function run()
    {
        ...
        if (($keyValue = Get("id") ?? Route("id")) !== null) {
            ...
            $returnUrl = "TaskerList"; // Return to list
        }
        ...
        switch ($this->CurrentAction) {
            case "show": // Get a record to display
                    ...
                    if (!$res) { // Load record based on key
                        ...
                        $returnUrl = "TaskerList"; // No matching record, return to list
                    }
                break;
        }
        if ($returnUrl != "") {
