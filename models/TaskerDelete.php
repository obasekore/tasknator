 ...
 * Page class
 */
class TaskerDelete extends Tasker
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "TaskerDelete";
    ...
    // CSS class/style
    public $CurrentPageName = "TaskerDelete";
    ...
    public function run()
    {
        ...
        if ($filter == "") {
            $this->terminate("TaskerList"); // Prevent SQL injection, return to list
            return;
        }
        ...
        if ($this->isShow()) { // Load records for display
            ...
            if ($this->TotalRecords <= 0) { // No record found, exit
                $this->Recordset?->free();
                $this->terminate("TaskerList"); // Return to list
                return;
            }
        }
