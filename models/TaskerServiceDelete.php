 ...
 * Page class
 */
class TaskerServiceDelete extends TaskerService
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "TaskerServiceDelete";
    ...
    // CSS class/style
    public $CurrentPageName = "TaskerServiceDelete";
    ...
    public function run()
    {
        ...
        if ($filter == "") {
            $this->terminate("TaskerServiceList"); // Prevent SQL injection, return to list
            return;
        }
        ...
        if ($this->isShow()) { // Load records for display
            ...
            if ($this->TotalRecords <= 0) { // No record found, exit
                $this->Recordset?->free();
                $this->terminate("TaskerServiceList"); // Return to list
                return;
            }
        }
