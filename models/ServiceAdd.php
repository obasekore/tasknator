...
class ServiceAdd extends Service
{
    ...
    // CSS class/style
    public $CurrentPageName = "ServiceAdd";
        ...
        switch ($this->CurrentAction) {
            ...
            case "insert": // Add new record
                ...
                if ($this->addRow($rsold)) { // Add successful
                    ...
                    } elseif (GetPageName($returnUrl) == "ServiceView") {
    ...
    protected function getAddRow()
    {
        ...
        // parent
        $this->_parent->setDbValueDef($rsnew, $this->_parent->CurrentValue, false);
    ...
    protected function restoreAddFormFromRow($row)
    {
        if (isset($row['parent'])) { // parent
            $this->_parent->setFormValue($row['parent']);
        }
