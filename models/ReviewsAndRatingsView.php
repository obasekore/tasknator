 ...
 * Page class
 */
class ReviewsAndRatingsView extends ReviewsAndRatings
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "ReviewsAndRatingsView";
    ...
    // CSS class/style
    public $CurrentPageName = "ReviewsAndRatingsView";
    ...
    public function __construct()
    {
        ...
        if (($keyValue = Get("ReviewRatingID") ?? Route("ReviewRatingID")) !== null) {
            $this->RecKey["ReviewRatingID"] = $keyValue;
        }
    ...
    public function run()
    {
        ...
        if (($keyValue = Get("ReviewRatingID") ?? Route("ReviewRatingID")) !== null) {
            ...
            $this->RecKey["ReviewRatingID"] = $this->ReviewRatingID->QueryStringValue;
        } elseif (Post("ReviewRatingID") !== null) {
            $this->ReviewRatingID->setFormValue(Post("ReviewRatingID"));
            $this->RecKey["ReviewRatingID"] = $this->ReviewRatingID->FormValue;
        } elseif (IsApi() && ($keyValue = Key(0) ?? Route(2)) !== null) {
            $this->ReviewRatingID->setQueryStringValue($keyValue);
            $this->RecKey["ReviewRatingID"] = $this->ReviewRatingID->QueryStringValue;
        } elseif (!$loadCurrentRecord) {
            $returnUrl = "ReviewsAndRatingsList"; // Return to list
        }
        ...
        switch ($this->CurrentAction) {
            case "show": // Get a record to display
                    ...
                    if (!$res) { // Load record based on key
                        ...
                        $returnUrl = "ReviewsAndRatingsList"; // No matching record, return to list
                    }
                break;
        }
        if ($returnUrl != "") {
