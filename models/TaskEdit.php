...
class TaskEdit extends Task
{
    ...
    // CSS class/style
    public $CurrentPageName = "TaskEdit";
    ...
    protected function getEditRow($rsold)
    {
        ...
        // tasker_id
        $this->tasker_id->setDbValueDef($rsnew, $this->tasker_id->CurrentValue, $this->tasker_id->ReadOnly);
    ...
    protected function restoreEditFormFromRow($row)
    {
        ...
        if (isset($row['tasker_id'])) { // tasker_id
            $this->tasker_id->CurrentValue = $row['tasker_id'];
        }
