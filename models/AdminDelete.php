 ...
 * Page class
 */
class AdminDelete extends Admin
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "AdminDelete";
    ...
    // CSS class/style
    public $CurrentPageName = "AdminDelete";
    ...
    public function run()
    {
        ...
        if ($filter == "") {
            $this->terminate("AdminList"); // Prevent SQL injection, return to list
            return;
        }
        ...
        if ($this->isShow()) { // Load records for display
            ...
            if ($this->TotalRecords <= 0) { // No record found, exit
                $this->Recordset?->free();
                $this->terminate("AdminList"); // Return to list
                return;
            }
        }
