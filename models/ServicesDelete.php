 ...
 * Page class
 */
class ServicesDelete extends Services
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "ServicesDelete";
    ...
    // CSS class/style
    public $CurrentPageName = "ServicesDelete";
    ...
    public function run()
    {
        ...
        if ($filter == "") {
            $this->terminate("ServicesList"); // Prevent SQL injection, return to list
            return;
        }
        ...
        if ($this->isShow()) { // Load records for display
            ...
            if ($this->TotalRecords <= 0) { // No record found, exit
                $this->Recordset?->free();
                $this->terminate("ServicesList"); // Return to list
                return;
            }
        }
