 ...
 * Page class
 */
class TasksDelete extends Tasks
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "TasksDelete";
    ...
    // CSS class/style
    public $CurrentPageName = "TasksDelete";
    ...
    public function run()
    {
        ...
        if ($filter == "") {
            $this->terminate("TasksList"); // Prevent SQL injection, return to list
            return;
        }
        ...
        if ($this->isShow()) { // Load records for display
            ...
            if ($this->TotalRecords <= 0) { // No record found, exit
                $this->Recordset?->free();
                $this->terminate("TasksList"); // Return to list
                return;
            }
        }
