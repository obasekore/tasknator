...
class User extends DbTable
{
    ...
    public function __construct()
    {
        ...
        $this->role_id->addMethod("getDefault", fn() => 3);
        ...
        $this->role_id->Lookup = new Lookup($this->role_id, 'UserLevels', false, 'UserLevelID', ["UserLevelName","","",""], '', '', [], [], [], [], [], [], false, '', '', "`UserLevelName`");
    ...
    public function getModalCaption($pageName)
    {
        ...
        return match ($pageName) {
            "UserView" => $Language->phrase("View"),
            "UserEdit" => $Language->phrase("Edit"),
            "UserAdd" => $Language->phrase("Add"),
            default => ""
        };
    }
    ...
    public function getApiPageName($action)
    {
        return match (strtolower($action)) {
            Config("API_VIEW_ACTION") => "UserView",
            Config("API_ADD_ACTION") => "UserAdd",
            Config("API_EDIT_ACTION") => "UserEdit",
            Config("API_DELETE_ACTION") => "UserDelete",
            Config("API_LIST_ACTION") => "UserList",
            default => ""
        };
    }
    ...
    public function getDeleteUrl($parm = "")
    {
        if ($this->UseAjaxActions && ConvertToBool(Param("infinitescroll")) && CurrentPageID() == "list") {
            ...
            return $this->keyUrl("UserDelete", $parm);
        }
    }
    ...
    {
        global $Security;
        $userIdFilter = '`email` = ' . QuotedValue($userId, DataType::STRING, Config("USER_TABLE_DBID"));
        return $userIdFilter;
    }
