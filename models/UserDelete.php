...
class UserDelete extends User
{
    ...
    // CSS class/style
    public $CurrentPageName = "UserDelete";
    ...
    public function run()
    {
        ...
        if ($filter == "") {
            $this->terminate("UserList"); // Prevent SQL injection, return to list
            return;
        }
        ...
        if (!$res) {
            $this->terminate("UserList"); // Return to list
            return;
        }
