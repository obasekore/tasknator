...
class RoleView extends Role
{
    ...
    // CSS class/style
    public $CurrentPageName = "RoleView";
    ...
    public function run()
    {
        ...
        if (($keyValue = Get("id") ?? Route("id")) !== null) {
            ...
            $returnUrl = "RoleList"; // Return to list
        }
        ...
        switch ($this->CurrentAction) {
            case "show": // Get a record to display
                    ...
                    if (!$res) { // Load record based on key
                        ...
                        $returnUrl = "RoleList"; // No matching record, return to list
                    }
                break;
        }
        if ($returnUrl != "") {
